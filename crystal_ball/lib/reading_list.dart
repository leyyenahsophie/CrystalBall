...
class ReadingListPage extends StatelessWidget {
  ...
  final List<String> currentlyReading = ['Book D', 'Book E', 'Book F', 'Book G'];
  final List<String> finishedReading = ['Book H', 'Book I', 'Book J', 'Book K'];
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _bookGrid(wantToRead),

                  const SizedBox(height: 20),

                  // Currently Reading
                  _sectionTitle("Currently Reading"),
                  _bookGrid(currentlyReading),

                  const SizedBox(height: 20),

                  // Finished Reading
                  _sectionTitle("Finished Reading"),
                  _bookGrid(finishedReading),
                ],
              ),
            ),
          ),
